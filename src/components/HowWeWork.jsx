...
export default function HowWeWork() {
  return (
    <section id="how-we-work" className="relative py-20 sm:py-28 bg-[#080810]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6">
          {steps.map((s, i) => (
            <ScrollReveal key={s.number} delay={i * 100}>
              <div className="group relative h-full p-6 rounded-2xl border border-white/5 bg-white/[0.02] hover:border-cyan-400/30 hover:bg-white/[0.04] transition-all duration-500 hover:-translate-y-1">
                {i < steps.length - 1 && (
