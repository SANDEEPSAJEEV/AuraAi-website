    ...
    <section id="how-we-work" className="py-24 bg-[#0d0d14]">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {steps.map((s, i) => (
            <div key={s.number} className="relative p-6 rounded-2xl border border-white/5 bg-white/[0.02]">
              {/* Connector line */}
              {i < steps.length - 1 && (
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <div key={c.title} className="flex gap-4 p-6 rounded-xl border border-white/5 bg-white/[0.02]">
