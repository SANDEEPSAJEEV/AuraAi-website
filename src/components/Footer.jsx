...
export default function Footer() {
  return (
    <footer className="relative bg-[#050508] border-t border-white/5 pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-12 mb-12">
          <div className="md:col-span-6">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 mt-6 text-cyan-400 hover:text-cyan-300 text-sm font-medium transition-colors"
            >
          ...
          <div className="md:col-span-3">
            ...
            <ul className="space-y-3">
              <li><a href="#capabilities" className="text-slate-400 hover:text-cyan-400 text-sm transition-colors">About</a></li>
              <li><a href="#how-we-work" className="text-slate-400 hover:text-cyan-400 text-sm transition-colors">Our Process</a></li>
              <li><a href="#faq" className="text-slate-400 hover:text-cyan-400 text-sm transition-colors">FAQ</a></li>
